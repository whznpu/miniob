...
typedef struct {
  ...
  size_t value_insert_length; // the number of insert
...
// initialized and declared 'extern' 直接赋值会报错
...
void value_init_like(Value *value, const char *v);
void value_init_date(Value *value,const char *v);
int check_date(int y,int m,int d);
void value_destroy(Value *value);

// void like_init(Condition *like_condition,int istrue,RelAttr *left_attr,Value* right_value);
...
void inserts_init(Inserts *inserts, const char *relation_name, Value values[],
                  size_t value_num,size_t value_list_length);
...
void create_unique_index_init(CreateUniqueIndex *create_unique_index,
                              const char *index_name, const char *relation_name,
                              const char *attr_name);
void create_unique_index_reset(CreateUniqueIndex *create_unique_index);
void create_unique_index_append_attribute(
    CreateUniqueIndex *create_unique_index, const char *attr_name);
